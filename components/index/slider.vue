...
const list = ref([
  //
  '/assets/index/key2.webp',
  '/assets/index/key3.webp',
  '/assets/index/key1.webp',
  '/assets/index/key4.webp',
]);
</script>
<template>
  <div class="w-full min-h-[150px] md:min-h-[350px] max-h-[300px] :max-h-[600px]">
    <ClientOnly>
      <div data-hs-carousel='{"loadingClasses": "opacity-0","isAutoPlay": true}' class="relative">
        <div
          class="hs-carousel relative overflow-hidden w-full min-h-[150px] md:min-h-[350px] max-h-[300px] :max-h-[600px] bg-white"
        >
          <div
            class="hs-carousel-body absolute top-0 bottom-0 start-0 flex flex-nowrap transition-transform duration-700 opacity-0"
          >
            <template v-for="(url, index) in list" :key="index">
